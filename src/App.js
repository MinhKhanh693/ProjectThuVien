...
import { LoginLayout, RegisterLayout } from "./features/auth";
  ...
  return (
    <Fragment>
      ...
      <Routes>
        ...
        <Route
          path="/ProjectThuVien/detail-page/:id"
          element={<DetailPageLayout />}
        />
        <Route path="/login" element={<LoginLayout />} />
        <Route path="/Register" element={<RegisterLayout />} />
        <Route
          path="/ProjectThuVien/category-page"
          element={<CategoryPageLayout />}
        />
        <Route
          path="/ProjectThuVien/view-online/:id"
          element={<ViewOnlineProductLayout />}
        />
      </Routes>
      <Footer />
    </Fragment>
